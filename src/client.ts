...
export class AuthKitClient {
  ...
  constructor(config: AuthKitConfig) {
    ...
    this.config = {
      ...
      scopes: Array.isArray(config.scopes) ? config.scopes : ([...DEFAULTS.SCOPES] as Scope[]),
    ...
    this.storage = this.config.storage || (
      this.config.secureStorage ? new SecureStoreAdapter() : new AsyncStorageAdapter()
    );
